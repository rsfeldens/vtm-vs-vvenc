...
qt_0 = np.append(qt_0, 10.0)
qt_1 = np.append(qt_1, 47.0)
qt_2 = np.append(qt_2, 34.0)
qt_3 = np.append(qt_3, 8.5)
qt_4 = np.append(qt_4, 0.5)
...
plt.bar(qps, qt_4, width=0.5, color="#400A0A", edgecolor='black', linewidth=0.9)
plt.bar(qps, qt_3, width=0.5, bottom=qt_4, color="#701111", edgecolor='black', linewidth=0.9)
plt.bar(qps, qt_2, width=0.5, bottom=bottom2, color="#921B1B", edgecolor='black', linewidth=0.9)
plt.bar(qps, qt_1, width=0.5, bottom=bottom3, color="#D97171", edgecolor='black', linewidth=0.9)
plt.bar(qps, qt_0, width=0.5, bottom=bottom4, color="#EABFBF", edgecolor='black', linewidth=0.9)
...
##plt.legend()
plt.tight_layout()
plt.savefig("time_class_C.png", dpi=300) 
plt.close()
##plt.show()